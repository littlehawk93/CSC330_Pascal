...
public class compiler
{
		...
		public static String ErrMsg[] =
		{
			...
			"Until expected",/* 26 */
			"For must be followed by an identifier",/* 27 */
			"For must be followed by an identifier and assignment",/* 28 */
			"Expression expected after TO / DOWNTO",/* 29 */
			"Do expected after expression",/* 30 */
			"'(' expected",/* 31 */
			"')' expected",/* 32 */
			"Of expected",/* 33 */
			"Number or constant expected",/* 34 */
			"Cend expected",/* 35 */
		};
